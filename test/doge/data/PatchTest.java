...
public class PatchTest {
    ...
    public void testParsePatch() {
        ...
        assertEquals(
                ...
                Patch.parsePatch("00A58C94	0x5	1F D7 FF EB 10 	00 0A B4 EE 00 ",
                        testFunction1));
        ...
        assertEquals(
                new Patch(testFunction2, 0, 4,
                        new byte[]{(byte) 0xF0, (byte) 0x4F, (byte) 0x2D, (byte) 0xE9},
    ...
    public void testParsePatchLengthLargerThanBytesAvailable() {
        ...
        Patch patch = Patch
                .parsePatch("00A58C94	0x7	1F D7 FF EB 10 	00 0A B4 EE 00 ", testFunction);
    }
    ...
    public void testParsePatchInvalidNumberFormat() {
        Function testFunction = new Function("public int get_ActivateLimit()", 0xA58BDC);
        Patch patch = Patch
                .parsePatch("00A58C94	0x5	KF D7 FF EB 10 	00 0A B4 EE 00 ", testFunction);
    }
