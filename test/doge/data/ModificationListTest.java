...
public class ModificationListTest {
    ...
    @Test
    public void testConstuctorFromFile() throws IOException {
        ...
        assertEquals(ModificationList.parseListOfMods("#\n"
                        + "Infinite skill usage\n"
                        + "public int get_ActivateLimit(); // 0xA58E80\n"
                        + "00A58F27\t0x1\t0A \tEA\n"
                        + "#\n"
                        ...
                        + "00A57746\t0x1\t00 \tB4 \n"
                        + "00A57749\t0x2\t1A BF \t0A 20 "),
                ModificationList.parseFromFile("tempEmptyTestFile"));
    ...
    public void testContainsFunction() {
        ...
        // Contains
        assertTrue(modList.containsFunction(
